...
class Tag(models.Model):
    ...
    color = ColorField(
        ...
        unique=True,
        null=True,
        help_text=_('Выберите цвет'),
    )
    slug = models.SlugField(
        verbose_name=_('Адрес'),
        unique=True,
        help_text=_('Укажите уникальный Slug для тега'),
    )
...
class Recipe(models.Model):
    name = models.CharField(
        ...
        max_length=200,
        unique=True,
        help_text=_('Укажите название рецепта'),
    )
    ...
    image = models.ImageField(
        ...
        upload_to='recipe/',
        help_text=_('Загрузите фото готового блюда'),
    )
    cooking_time = models.PositiveSmallIntegerField(
        validators=(MinValueValidator(1),),
        verbose_name=_('Время приготовления'),
        help_text=_('Укажите время приготовления блюда'),
    )
...
class RecipeIngredient(models.Model):
    ...
    amount = models.FloatField(
        ...
        help_text=_('Количество единиц ингредиента'),
    )
